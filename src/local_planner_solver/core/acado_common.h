...
{
int dummy;
/** Matrix of size: 61 x 4 (row major format)
 * 
...
/** Matrix of size: 61 x 13 (row major format)
 * 
 ...
 * 
 *  Matrix containing 60 reference/measurement vectors of size 9 for first 60 nodes.
 */
real_t y[ 540 ];
...
/** Matrix of size: 7320 x 2 (row major format) */
real_t E[ 14640 ];
